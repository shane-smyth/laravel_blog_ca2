            ...
            <div class="bg-white rounded-lg shadow-xl overflow-hidden mb-8">
                <div class="p-6">
                    <div class="flex items-center justify-between">
                        ...
                        <!-- Settings Button -->
                        <a href="{{ route('account.settings') }}" class="flex items-center space-x-2 px-6 py-3 bg-secondary-green text-light-beige rounded-lg hover:bg-primary-green transition duration-150">
