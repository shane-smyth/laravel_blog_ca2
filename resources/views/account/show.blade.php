...
{{--                <div class="px-6 py-4 bg-primary-green">--}}
{{--                    <h2 class="text-2xl font-bold text-light-beige">Gardener's Profile</h2>--}}
{{--                </div>--}}
                ...
                <div class="p-6">
                    ...
                    @else
                        <div class="text-center py-8">
                            ...
                            <p class="mt-1 text-sm text-secondary-green">This gardener hasn't shared any experiences yet</p>
                        </div>
                    @endif
                </div>
            </div>
